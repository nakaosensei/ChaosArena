class Demon {  
  ...
  doCreate(){    
    ...
    //this.phaserObject.callAll('animations.add', 'animations', this.spritesheet, this.vetorEsquerda, this.speed, true);
  ...
  destroyItself(destroyer,victim){
      ...
      var demonDrop = Math.floor(Math.random() * 10) + 1;
      if(drop==0&&(demonDrop==1)){
